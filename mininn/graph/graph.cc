...
void Graph::add_node(std::shared_ptr<Node>& node, std::vector<int>& inputs,
...
std::vector<std::shared_ptr<Node>>& Graph::get_nodes() { return nodes_; }
...
std::vector<std::shared_ptr<Tensor>>& Graph::get_tensors() { return tensors_; }

void Graph::set_inputs(std::vector<int>& inputs) { inputs_ = inputs; }

std::vector<int>& Graph::get_inputs() { return inputs_; }

void Graph::set_outputs(std::vector<int>& outputs) { outputs_ = outputs; }

std::vector<int>& Graph::get_outputs() { return outputs_; }